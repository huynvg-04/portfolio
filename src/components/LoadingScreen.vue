...
onMounted(() => {
  ...
  const updateProgress = (currentTime) => {
    ...
    percent.value = Math.floor(progress);
...
<template>
  <div class="loading-screen">
    <div class="loading-header">
      <a href="/#" class="loader-title" data-cursor="disable">
        &lt;huynvg-04/&gt;
      </a>
      <div class="loaderGame" :class="{ 'loader-out': clicked }">
        <div class="loaderGame-container">
          <div class="loaderGame-in">
            <div class="loaderGame-line" v-for="index in 27" :key="index"></div>
          </div>
...
.marquee-track-custom span {
  padding: 0px 50px;
  position: relative;
  white-space: nowrap;
}

.marquee-track-custom span::before {
  content: "";
  width: 20px;
  height: 20px;
  background-color: #000;
